...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" version="1.0" xmlns:mssqlcrt="urn:sql-microsoft-com:sqlcrt" xmlns:mssqldbg="urn:sql-microsoft-com:sqldbg">
	...
	<!-- Discover DQ Capabilities for Proxy Model Support Functions -->
	<xsl:template match="OpDQCapabilityDiscoveryProxyModelSupportFunctions">
	SELECT FUNCTION_NAME, ORIGIN FROM $System.MDSCHEMA_FUNCTIONS WHERE ORIGIN = 3 OR ORIGIN = 4
	</xsl:template>
</xsl:stylesheet>
