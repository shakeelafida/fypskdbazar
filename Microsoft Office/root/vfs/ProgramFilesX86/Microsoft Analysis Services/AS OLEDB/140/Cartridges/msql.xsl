...
<xsl:otherwise>
<xsl:choose>
<xsl:when test="name(..) != 'Statement' and name(..) != 'Insert' and name(..) != 'Union' and name(..) != 'UnionAll' and name(..) != 'OpCorrelationId' and name(..) != 'AddQueryHint' and name(..) != 'concatenate-children'">
(
</xsl:when>
<xsl:when test="name(..) = 'Statement' and count(.//Recursion) != 0">
; WITH
...
<xsl:if test="name(..) != 'Statement' and name(..) != 'Insert' and name(..) != 'Union' and name(..) != 'UnionAll' and name(..) != 'OpCorrelationId' and name(..) != 'AddQueryHint' and name(..) != 'concatenate-children'">
)
</xsl:if>
</xsl:otherwise>
</xsl:choose>
...
<!-- Since Mashup is not able to fold query with Chechsum within subquery, we added a hack in OpHash to generate the special syntax that is acceptable in Mashup.
Therefore, if we see APPROXIMATEDISTINCTCOUNT(HASH(col1,...)) cases, this will be a no op.-->
